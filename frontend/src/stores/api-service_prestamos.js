...
export function guardarPrestamo(prestamo) {
  ...
  data["_links"]["documento"]["href"] = cambiarHttpPorHttps(
    prestamo.documento._links.self.href
  );
...
export function convierteFecha(date) {
  ...
  return (
    date.getFullYear() + "-" + mesFecha + "-" + diaFecha + "T00:00:00.00+00:00"
  );
}
